...
public sealed partial class NewsReaderUiFragment : BoxContainer
{
    ...
    public NewsReaderUiFragment()
    {
        ...
        Prev.StyleBoxOverride = PdaTerminalPalette.CreateButton();
        Next.StyleBoxOverride = PdaTerminalPalette.CreateButton();
        NotificationSwitch.StyleBoxOverride = PdaTerminalPalette.CreateButton(accented: true);
