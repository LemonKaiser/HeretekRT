...
namespace Content.Client.Eye.Blinding
{
    public sealed partial class BlindOverlay : Overlay
    {
        ...
        public BlindOverlay()
        {
            ...
            _greyscaleShader = _prototypeManager.Index<ShaderPrototype>(new Robust.Shared.Prototypes.ProtoId<ShaderPrototype>("GreyscaleFullscreen")).InstanceUnique();
            _circleMaskShader = _prototypeManager.Index<ShaderPrototype>(new Robust.Shared.Prototypes.ProtoId<ShaderPrototype>("CircleMask")).InstanceUnique();
        }
