...
public sealed partial class GuideReagentEmbed : BoxContainer, IDocumentTag, ISearchableControl
{
    ...
    public bool TryParseTag(Dictionary<string, string> args, [NotNullWhen(true)] out Control? control)
    {
        ...
        {
            Logger.GetSawmill("client").Error("Reagent embed tag is missing reagent prototype argument");
            return false;
        }

        if (!_prototype.TryIndex<ReagentPrototype>(id, out var reagent))
        {
            Logger.GetSawmill("client").Error($"Specified reagent prototype \"{id}\" is not a valid reagent prototype");
            return false;
        }
