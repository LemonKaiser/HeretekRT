...
public sealed partial class MarkingPicker : Control
{
    ...
    private SpriteSystem Sprite => _entityManager.System<SpriteSystem>();
    ...
    public void Populate(string filter)
    {
        ...
        foreach (var marking in sortedMarkings)
        {
            ...
            var item = CMarkingsUnused.AddItem($"{GetMarkingName(marking)}", Sprite.Frame0(marking.Sprites[0]));
    ...
    public void PopulateUsed()
    {
        ...
        foreach (var marking in _currentMarkings.GetReverseEnumerator(_selectedMarkingCategory))
        {
            ...
            {
                Text = text,
                Icon = Sprite.Frame0(newMarking.Sprites[0]),
                Selectable = true,
                Metadata = newMarking,
    ...
    private void MarkingAdd()
    {
        ...
        var item = new ItemList.Item(CMarkingsUsed)
        {
            ...
            Icon = Sprite.Frame0(marking.Sprites[0]),
            Selectable = true,
            Metadata = marking,
        };
