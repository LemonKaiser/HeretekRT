...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class HumanoidProfileEditor : BoxContainer
    {
        ...
        private Wh40kExtendedDescription? _extendedDescription;
        private int? _extendedDescriptionTab;
            ...
            CompanyManager manager) // Mono
        {
            ...
            TabContainer.OnTabChanged += OnProfileEditorTabChanged;
        ...
        public void RefreshFlavorText()
        {
            if (_cfgManager.GetCVar(CCVars.FlavorText))
            {
                ...
                _extendedDescription = new Wh40kExtendedDescription();
                TabContainer.AddChild(_extendedDescription);
                _extendedDescriptionTab = TabContainer.ChildCount - 1;
                TabContainer.SetTabTitle(_extendedDescriptionTab.Value, Loc.GetString("humanoid-profile-editor-flavortext-tab"));
                _extendedDescription.OnFlavorTextChanged += OnFlavorTextChange;
                _extendedDescription.OnOocFlavorTextChanged += OnOocFlavorTextChange;
                _extendedDescription.OnCharacterFlavorTextChanged += OnCharacterFlavorTextChange;
                _extendedDescription.OnGreenFlavorTextChanged += OnGreenFlavorTextChange;
                _extendedDescription.OnYellowFlavorTextChanged += OnYellowFlavorTextChange;
                _extendedDescription.OnRedFlavorTextChanged += OnRedFlavorTextChange;
                _extendedDescription.OnTagsFlavorTextChanged += OnTagsFlavorTextChange;
                _extendedDescription.OnLinksFlavorTextChanged += OnLinksFlavorTextChange;
                _extendedDescription.OnShareOocFlavorTextChanged += OnShareOocFlavorTextChange;
                _extendedDescription.OnShareLinksFlavorTextChanged += OnShareLinksFlavorTextChange;
                _extendedDescription.OnSharePreferencesFlavorTextChanged += OnSharePreferencesFlavorTextChange;
                _extendedDescription.SetProfile(Profile);
                UpdateProfilePreviewSidebar(TabContainer.CurrentTab);
            }
            else
            {
                if (_extendedDescription == null)
                ...
                if (_extendedDescriptionTab is { } tab && TabContainer.CurrentTab == tab)
                    TabContainer.CurrentTab = 0;

                TabContainer.RemoveChild(_extendedDescription);
                _extendedDescription.OnFlavorTextChanged -= OnFlavorTextChange;
                _extendedDescription.OnOocFlavorTextChanged -= OnOocFlavorTextChange;
                _extendedDescription.OnCharacterFlavorTextChanged -= OnCharacterFlavorTextChange;
                _extendedDescription.OnGreenFlavorTextChanged -= OnGreenFlavorTextChange;
                ...
                _extendedDescription.OnShareLinksFlavorTextChanged -= OnShareLinksFlavorTextChange;
                _extendedDescription.OnSharePreferencesFlavorTextChanged -= OnSharePreferencesFlavorTextChange;
                _extendedDescription.Dispose();
                _extendedDescription = null;
                _extendedDescriptionTab = null;
                ProfilePreviewSidebar.Visible = true;
            }
        }

        private void OnProfileEditorTabChanged(int tab)
        {
            UpdateProfilePreviewSidebar(tab);
        }

        private void UpdateProfilePreviewSidebar(int tab)
        {
            ProfilePreviewSidebar.Visible = _extendedDescriptionTab != tab;
        }
        ...
        private void ReloadPreview()
        {
            ...
            _extendedDescription?.SetPreviewEntity(PreviewDummy);
        ...
        private void RefreshWh40kPortrait()
        {
            if (Profile?.Wh40kBuild.PortraitId is not { } portraitId ||
                !_prototypeManager.TryIndex<Wh40kPortraitPrototype>(portraitId, out var portrait))
            {
                Wh40kPortraitFrame.Visible = false;
                _extendedDescription?.SetPortrait(null);
                return;
            }

            var portraitTexture = _entManager.System<SpriteSystem>().Frame0(portrait.LargeSprite);
            Wh40kPortrait.Texture = portraitTexture;
            Wh40kPortraitFrame.Visible = true;
            _extendedDescription?.SetPortrait(portraitTexture);
        }
        ...
        private void OnCharacterFlavorTextChange(string content)
        {
            ...
            Profile = Profile.WithCharacterFlavorText(content);
            SetDirty();
        }
        ...
        private void OnGreenFlavorTextChange(string content)
        {
            ...
            Profile = Profile.WithGreenFlavorText(content);
            SetDirty();
        }
        ...
        private void OnYellowFlavorTextChange(string content)
        {
            ...
            Profile = Profile.WithYellowFlavorText(content);
            SetDirty();
        }
        ...
        private void OnRedFlavorTextChange(string content)
        {
            ...
            Profile = Profile.WithRedFlavorText(content);
            SetDirty();
        }
        ...
        private void OnTagsFlavorTextChange(string content)
        {
            ...
            Profile = Profile.WithTagsFlavorText(content);
            SetDirty();
        }
        ...
        private void OnLinksFlavorTextChange(string content)
        {
            ...
            Profile = Profile.WithLinksFlavorText(content);
            SetDirty();
        }

        private void OnShareOocFlavorTextChange(bool share)
        {
            if (Profile is null)
                return;

            Profile = Profile.WithShareOocFlavorText(share);
            SetDirty();
        }

        private void OnShareLinksFlavorTextChange(bool share)
        {
            if (Profile is null)
                return;

            Profile = Profile.WithShareLinksFlavorText(share);
            SetDirty();
        }

        private void OnSharePreferencesFlavorTextChange(bool share)
        {
            if (Profile is null)
                return;

            Profile = Profile.WithSharePreferencesFlavorText(share);
            SetDirty();
        }
