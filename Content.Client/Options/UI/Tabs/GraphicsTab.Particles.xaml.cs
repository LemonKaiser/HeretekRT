...
public sealed partial class GraphicsTab
{
    private sealed class OptionParticleQuality : BaseOption
    {
        ...
        public OptionParticleQuality(OptionsTabControlRow controller, IConfigurationManager cfg, OptionDropDown dropDown)
            : base(controller)
        {
            _cfg = cfg;
            _dropDown = dropDown;
        ...
        {
            return _dropDown.Button.SelectedId != Math.Clamp(_cfg.GetCVar(CCVars.ParticleQuality), QualityOff, QualityHigh);
        }
