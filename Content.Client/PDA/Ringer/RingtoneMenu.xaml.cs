...
namespace Content.Client.PDA.Ringer
{
    ...
    public sealed partial class RingtoneMenu : PdaWindow
    {
        ...
        public RingtoneMenu()
        {
            ...
            SequenceFrame.PanelOverride = PdaTerminalPalette.CreatePanel(
                PdaTerminalPalette.ScreenPanel,
                PdaTerminalPalette.Rail,
                new Thickness(1));
            ActionsFrame.PanelOverride = PdaTerminalPalette.CreatePanel(
                PdaTerminalPalette.RaisedPanel,
                PdaTerminalPalette.Rail,
                new Thickness(1));
            TestRingerButton.StyleBoxOverride = PdaTerminalPalette.CreateButton();
            SetRingerButton.StyleBoxOverride = PdaTerminalPalette.CreateButton(accented: true);
