...
public sealed partial class ViewportUIController : UIController
{
    ...
    public override void FrameUpdate(FrameEventArgs e)
    {
        ...
        Logger.GetSawmill("client").Warning($"Main viewport's eye is in nullspace (main eye is null?). Attached entity: {_entMan.ToPrettyString(ent.Value)}. Entity has eye comp: {eye != null}");
    }
}
