...
public sealed partial class GunPredictionSystem : SharedGunPredictionSystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        var predictedQuery = EntityQueryEnumerator<PredictedProjectileHitComponent, SpriteComponent>();
        while (predictedQuery.MoveNext(out var uid, out var hit, out var sprite))
        {
