...
public sealed class WH40KMutePanelEui : BaseEui
{
    ...
    public WH40KMutePanelEui()
    {
        ...
        _window.MuteSubmitted += request =>
        {
            _window.SetRequestPending(true);
            SendMessage(new WH40KMutePanelEuiStateMsg.CreateMuteRequest(request));
        };
    ...
    public override void HandleState(EuiStateBase state)
    {
        ...
        _window.UpdateMuteFlag(cast.CanMute, cast.RequestInFlight);
