        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    homeworld_id = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    origin_id = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    class_id = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    initial_portrait_id = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    initial_characteristic_points = table.Column<JsonDocument>(type: "jsonb", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    first_purchased_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_wh40k_account_attribute_purchase_wh40k_account_rpg_foundati~",
                        column: x => x.user_id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    experience_tenths = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_wh40k_account_rpg_progress_wh40k_account_rpg_foundation_wh4~",
                        column: x => x.user_id,
                        principalTable: "wh40k_account_rpg_foundation",
                        principalColumn: "user_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    wh40k_experience_ledger_id = table.Column<long>(type: "bigint", nullable: false)
                    ...
                    amount_tenths = table.Column<long>(type: "bigint", nullable: false),
                    round_id = table.Column<int>(type: "integer", nullable: true),
                    issuer_entity = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    context_json = table.Column<JsonDocument>(type: "jsonb", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_wh40k_experience_ledger_wh40k_account_rpg_foundation_wh40k_~",
                        column: x => x.user_id,
                        principalTable: "wh40k_account_rpg_foundation",
                        principalColumn: "user_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    wh40k_party_id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_wh40k_party_wh40k_account_rpg_foundation_wh40k_account_rpg_~",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    user_id = table.Column<Guid>(type: "uuid", nullable: false),
                    allow_invites = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_wh40k_party_preference", x => x.user_id);
                    table.ForeignKey(
                        name: "FK_wh40k_party_preference_wh40k_account_rpg_foundation_wh40k_a~",
                        column: x => x.user_id,
                        principalTable: "wh40k_account_rpg_foundation",
                        principalColumn: "user_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    wh40k_reward_delivery_id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    user_id = table.Column<Guid>(type: "uuid", nullable: false),
                    reward_id = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    entry_id = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    reward_type = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    prototype_id = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_wh40k_reward_delivery_wh40k_account_rpg_foundation_wh40k_ac~",
                        column: x => x.user_id,
                        principalTable: "wh40k_account_rpg_foundation",
                        principalColumn: "user_id",
                        onDelete: ReferentialAction.Cascade);
