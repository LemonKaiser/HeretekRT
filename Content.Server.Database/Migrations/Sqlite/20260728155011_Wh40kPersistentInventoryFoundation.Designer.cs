...
namespace Content.Server.Database.Migrations.Sqlite
{
    ...
    [Migration("20260728155011_Wh40kPersistentInventoryFoundation")]
            ...
            modelBuilder.Entity("Content.Server.Database.Wh40kPersistentInventoryAudit", b =>
                {
                    b.HasOne("Content.Server.Database.Wh40kPersistentInventory", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_wh40k_persistent_inventory_audit_wh40k_persistent_inventory_wh40k_persistent_inventory_user_id");
                });
