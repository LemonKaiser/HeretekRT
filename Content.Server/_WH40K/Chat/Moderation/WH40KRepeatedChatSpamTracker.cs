...
/// <summary>Tracks identical normalized messages for one player inside a rolling moderation window.</summary>
internal sealed class WH40KRepeatedChatSpamTracker
{
        ...
        TimeSpan? adminAnnounceDelay)
    {
        ...
        {
            entry = new Entry { ExpiresAt = now + period };
        }
        ...
        var firstViolation = !entry.ViolationHandled;
        entry.ViolationHandled = true;
