...
namespace Content.Shared.Humanoid
{
    ...
    public sealed partial class NamingSystem : EntitySystem
    {
        ...
        private string PickLocalizedDatasetValue(string datasetId)
        {
            ...
            var dataset = _prototypeManager.Index<DatasetPrototype>(datasetId);
            var index = _random.Next(dataset.Values.Count);
            return DatasetLocalizationHelpers.GetLocalizedValue(dataset, index);
        }
    }
}
