...
[Discord](https://discord.gg/cs7Ynakgvd) | [Steam](https://store.steampowered.com/app/1255460/Space_Station_14/)
...
Refer to [the Space Wizards' guide](https://docs.spacestation14.com/en/general-development/setup/setting-up-a-development-environment.html) on setting up a development environment for general information, but keep in mind that Heretek is not the same and many things may not apply.
