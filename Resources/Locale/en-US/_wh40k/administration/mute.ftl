...
wh40k-mute-command-invalid-scope-mask = The requested mute scope is invalid.
wh40k-mute-command-invalid-duration = Temporary mute duration must be between 1 minute and 10 years.
wh40k-mute-command-invalid-erase = Unknown erase flag: {$value}
wh40k-mute-target-host-protected = This target is protected from administrative mutes.
wh40k-mute-command-success = Mute applied to {$player}.
wh40k-mute-player-notification = You have received an administrative mute. Chat and AHelp input are blocked for the selected scopes.
...
wh40k-mute-list-previous-page = Previous
wh40k-mute-list-next-page = Next
wh40k-mute-list-page = Page {$page}
