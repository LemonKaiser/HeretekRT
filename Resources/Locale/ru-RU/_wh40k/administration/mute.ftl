...
wh40k-mute-command-invalid-scope-mask = Запрошена некорректная область мута.
wh40k-mute-command-invalid-duration = Временный мут должен длиться от 1 минуты до 10 лет.
wh40k-mute-command-invalid-erase = Неизвестное значение erase: {$value}
wh40k-mute-target-host-protected = Эта цель защищена от административных мутов.
wh40k-mute-command-success = Мут выдан игроку {$player}.
wh40k-mute-player-notification = Вам выдан административный мут. Ввод чата и АХелпа заблокирован согласно выбранным областям.
...
wh40k-mute-list-previous-page = Назад
wh40k-mute-list-next-page = Вперёд
wh40k-mute-list-page = Страница {$page}
