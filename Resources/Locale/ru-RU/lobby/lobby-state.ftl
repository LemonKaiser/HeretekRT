...
lobby-state-background-text = Фон меню: [color=white]{ $backgroundTitle }[/color], автор [color=white]{ $backgroundArtist }[/color]
lobby-state-background-no-background-text = Фон меню не загружен.
