...
humanoid-profile-editor-preference-unavailable-spawn-as-overflow-button = Получить должность «{$overflowJob}», если выбранная должность недоступна.
...
humanoid-profile-editor-company-no-description = Описание отсутствует
humanoid-profile-editor-trait-tooltip-excluded-traits = Нельзя иметь одну из этих черт: { $traits }
humanoid-profile-editor-trait-tooltip-excluded-species = Нельзя быть этой расой: { $species }
