...
shuttle-console-navigation-mode = Режим навигации
shuttle-console-navigation-mode-bss = БСС
...
shuttle-console-auto-dock = Автостыковка
shuttle-console-auto-dock-enabled = Вкл
shuttle-console-auto-dock-disabled = Выкл
shuttle-console-auto-dock-button = Автостыковка
shuttle-console-auto-dock-no-target = В радиусе 300 м нет станции или шаттла для стыковки.
shuttle-console-auto-dock-invalid-ports = Для автостыковки нужны свободные совместимые стыковочные шлюзы на обоих объектах.
shuttle-console-auto-dock-off = Автостыковка выключена.
shuttle-console-auto-dock-complete = Автостыковка завершена.
shuttle-console-auto-dock-failed = Автостыковка прервана: шаттл не смог завершить манёвр.
